...
to use other types of databases. We create a specific behavior%
\sidenote{
  Erlang behaviors \citep{ErlangBehaviour} are a set of specifications that
  can be used to create a generic reusable component.
}
for this purpose. Drivers can then be written for different databases
implementing the functions specified in the behavior.
