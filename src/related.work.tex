...
shows the different communication protocols used between its processes.
...
Erlang based implementations below since this thesis project is
implemented in it.
...
\todo{Add more details and explain differences}
