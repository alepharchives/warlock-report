...
protocol, we chose to use the protocol in the already established form of a
...
characterized by their ability to scale their operations \citep{Cattell10}.}
...
\sidenote{
  \emph{Vnodes} or ``Virtual Nodes" are a level of indirection used to map
